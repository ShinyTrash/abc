...
<toast scenario="{{.Scenario}}" activationType="{{.ActivationType}}" launch="{{.ActivationArguments}}" duration="{{.Duration}}">
	{{if or .Header.Id .Header.Title .Header.Arguments}}
...
// Header
//
// Defines a header to group notification
// See https://docs.microsoft.com/en-us/windows/uwp/design/shell/tiles-and-notifications/toast-headers?tabs=builder-syntax for more info.
//
